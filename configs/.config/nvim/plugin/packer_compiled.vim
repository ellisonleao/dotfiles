...
_G.packer_plugins = {
  ...
  ["vim-go"] = {
    loaded = true,
    path = "/home/ellison/.local/share/nvim/site/pack/packer/start/vim-go"
  },
  ["vim-repeat"] = {
    loaded = true,
